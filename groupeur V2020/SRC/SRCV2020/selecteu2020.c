...
int RUM_V_2020(const char* bufin,char VERS[])
{
 if (strncmp(bufin+OffsetVersionRUM_2020,VERS,LgVersionRUM_2020)==0) return(0);
 else return(1);
 }
...
/*
char* ReturnChar_2020(const char* Rum,int Offset,int Longueur)
{
	char* Resultat;
...
{
	/*return ReturnChar_2020(Rum,OffsetVersionRUM_2020,LgVersionRUM_2020);*/
    return Rum+OffsetVersionRUM_2020;
}
...
int GetVersion_2020(const char* Rum, int Format)
{
	if(Format!=-1)
		return Format;
/*FG10c*/
    if(RUM_V_2020(Rum,"013")==0)
		return 9;
/*FG11*/
    if(RUM_V_2020(Rum,"014")==0)
		return 10;
/*FG11b*/
    if(RUM_V_2020(Rum,"015")==0)
		return 11;
/*FG13*/
    if(RUM_V_2020(Rum,"016")==0)
		return 12;
/*format 017*/
	if ((RUM_V_2020(Rum, "018") == 0) || (RUM_V_2020(Rum, "017") == 0))
		return 13;
/*format 019*/
	if (RUM_V_2020(Rum, "019") == 0)
		return 14;
/*format 020*/
	if (RUM_V_2020(Rum, "020") == 0)
		return 15;
	return -1;
};
...
int GetNombreDiagnosticsNum_2020(const char* Rum, int Format)
{
	...
	tps[2] = 0;
	switch (GetVersion_2020(Rum, Format))
	{
/*format 016*/
...
/*format 020*/
	case 15: strncpy(tps, Rum + 125, 6); break;
	default:
			return NULL;
	};
	return TrimDiagnostic_2020(tps);
};
...
int GetTaille_2020(const char* Rum, int Format)
{
	...
	case 12:
		...
		tps = 177 + 8 * GetNombreDiagnosticsNum_2020(Rum, 12) + 26 * GetNombreActesNum_2020(Rum, 12) + 8 * atoi(zone);
		return tps;
		/*format 017 ou 018*/
	case 13:
		strncpy(zone, Rum + 120, 2);
		tps = 177 + 8 * GetNombreDiagnosticsNum_2020(Rum, 13) + 29 * GetNombreActesNum_2020(Rum, 13) + 8 * atoi(zone);
		return tps;
		/*format 019*/
	case 14:
		strncpy(zone, Rum + 120, 2);
		tps = 177 + 8 * GetNombreDiagnosticsNum_2020(Rum, 14) + 29 * GetNombreActesNum_2020(Rum, 14) + 8 * atoi(zone);
		return tps;
		/*format 020*/
	case 15:
		strncpy(zone, Rum + 120, 2);
		tps = 177 + 8 * GetNombreDiagnosticsNum_2020(Rum, 15) + 29 * GetNombreActesNum_2020(Rum, 15) + 8 * atoi(zone);
		return tps;
	default:
			return -1;
	};
...
char* RumToInterne_2020(const char* Rum, int Format)
{
    ...
    Format = GetVersion_2020(Rum, Format);
    Taille = GetTaille_2020(Rum, Format);
	NBDiags=GetNombreDiagnosticsNum_2020(Rum,Format);
	NBActes=GetNombreActesNum_2020(Rum,Format);
...
/*format 016*/
        case 12:
            ...
            tpsDiag2=TrimDiagnostic_2020(tpsDiag1);
...
/*format 019*/
	...
	/*format 020*/
		case 15:
			...
			/*variable pour la gradation HDJ*/
			memcpy(tps + 147, Rum + 164, 4);
			
			
			memcpy(tps + 151, Rum + 168, 6);/*filler*/
