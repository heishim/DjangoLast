...
#define MAXERRCTRL_2020 5000        /* Nombre maximum d'erreurs de contrôle pour un RSS */
#define MAXERRARB_2020  5           /* Nombre maximum d'erreurs de parcours de l'arbre de décision*/
#define MAXERRIMPL_2020 20          /* Nombre maximum d'erreurs d'implémentation*/
...
typedef struct GENT_2020 GRP_ENTREE_2020 ;
...
struct GRES_2020
{
    ...
    int ErrCtrl[MAXERRCTRL_2020];/*Tableau des erreurs de contrôle des RUM du RSS*/
    int ErrArb[MAXERRARB_2020];/*Tableau des erreurs de parcours de l'arbre de groupage*/
    int ErrImpl[MAXERRIMPL_2020];/*Tableau des erreurs d'implémentation*/
};
typedef struct GRES_2020 GRP_RESULTAT_2020 ;
...
typedef struct GVAL_2020 GHS_VALORISATION_2020 ;
...
typedef struct LD_2020 DIAGLIST_2020;
...
typedef struct LA_2020 ACTLIST_2020;

/*informations propre à un RUM*/
struct _INFO_RUM_2020
{
...
typedef struct _INFO_RUM_2020 INFO_RUM_2020;
...
struct RSSI_2020
{
    ...
    DIAGLIST_2020 diaglist ; /*liste de tous les diagnostics*/
    ACTLIST_2020 actlist; /*liste de tous les actes*/

    /*indicateur, RUM par RUM, de réa, de type d'Unité Médicale (UM) et de durée de séjour partielle*/
    INFO_RUM_2020 tabval[tab_max];
...
typedef struct RSSI_2020 RSS_INFO_2020;
